...
mapBB.setStrings({ helpContents: [
    ...
    '# Map... BBcode?',
    'When you click "Edit Raw", you will see the source code for your drawing. It is in <a href="https://github.com/MapBBCode/mapbbcode/blob/master/BBCODE.md" target="mapbb">[map] bbcode format</a>: think of it as GeoJSON with few predefined properties, adapted for using inside forum and blog posts. Yes, you can paste the code on some forums as-is, or embed a MapBBCode Share panel, which gets updated when the source drawing is updated, and has an "Export" button.',
    ...
    'The site was created by Ilya Zverev. <a href="https://github.com/MapBBCode/share.mapbbcode.org" target="mapbb">MapBBCode Share</a> version 1.1-3.'
]});
